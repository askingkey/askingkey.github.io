...
categories: [Bioinfo, Paper]
tags: [literature reading]     # TAG names should always be lowercase
pin: true
mermaid: true
math: true
---

写在前面：将近鸽了4个月之后，在满怀春意的姑苏，终于想起来我还有个web...于是整理了最近看的一篇DNA language model的paper，分享出来～（主要是担心自己时间久了会彻底忘记这篇的内容qaq）由于个人阅读习惯，这篇算是我的阅读笔记的整理版，所以更多的文字我会采用英文去总结，一些自己的感悟则是用中文写，防止错意。
